...
public class Followers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String uname = sp.getString("username", "N/A");
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent = new Intent(Followers.this, Others_Profile.class);
        ...
        StringRequest sr = new StringRequest(Request.Method.POST, urlJsonObj, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try{
                    if (response.equals(""))
                    {
                        Toast.makeText(getApplication(),"There's no one following you :/",Toast.LENGTH_LONG).show();
                        return;
                    } else
                    {
